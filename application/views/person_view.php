...
<body>
 <?php $this->load->view('header');?>
    ...
    <div class="panel-heading"><b>Daftar Anggota</b></div>
<!--         <h1 style="font-size:20pt">Ajax CRUD with Bootstrap modals and Datatables with Server side Validation</h1>
 
        <h3>Person Data</h3> -->
        <br />
        &nbsp <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add Person</button>
...
function bulk_delete()
{
    ...
    if(list_id.length > 0)
    {
        if(confirm('Are you sure to delete this ' +list_id.length+ ' data?'))
        {
            $.ajax({
                type: "POST",
                data: {id:list_id},
