...
class Person extends CI_Controller
{
    ...
    public function ajax_edit($id)
    {
        ...
        $data->dob = ($data->dob == '0000-00-00') ? '' : $data->dob;    //if 000-00-00 set to empty for datepicker compability
    ...
    public function ajax_update()
    {
        ...
        if($this->input->post('remove_photo'))  //if remove checked
        {
    ...
    private function _do_upload()
    {
        ...
        $config['max_size']         = 100;  //set max size in kb
